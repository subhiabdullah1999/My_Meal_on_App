...
class CustomCategoriesBotomApbar extends StatelessWidget {
  const CustomCategoriesBotomApbar({
    super.key,
  });

  @override
  Widget build(BuildContext context) {
    Get.put(CategoriesButtAbbarControllerImp());
    return GetBuilder<CategoriesButtAbbarControllerImp>(
